...
for i in range(1, 11):
    ...
    for j, row in df_.iterrows():
        ...
        step1 = f"{row['alcohol']}.{row['base']}>>{row['oxide']}.{row['conjugate_acid']}"
        step2 = f"{row['oxide']}.{row['sulfonyl_fluoride']}>>{row['sulfoxide']}.{row['fluoride']}"
        step3 = f"{row['sulfoxide']}.{row['fluoride']}>>{row['product']}"

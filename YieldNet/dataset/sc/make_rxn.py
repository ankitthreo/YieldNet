...
for i in range(1, 11):
    ...
    df.to_csv(f"./full/SC_FullCV_{str(i)}.csv", index=False)
    train.to_csv(f"./train/SC_FullCV_{str(i)}.csv", index=False)
    val.to_csv(f"./val/SC_FullCV_{str(i)}.csv", index=False)
    test.to_csv(f"./test/SC_FullCV_{str(i)}.csv", index=False)

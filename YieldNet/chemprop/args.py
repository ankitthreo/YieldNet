...
class TrainArgs(CommonArgs):
    ...
    use_lrl_network: bool = False
    """Switch for enabling LRL network in the MPN Encoder."""
    perm_type: Literal['soft', 'hard', 'none', 'nopm'] = 'soft'
    """Type of permutation for the P matrix."""
    format: Literal['perm', 'att'] = 'perm'
    """ Mode of differentiable operation to act on graphs for alignment"""
    similarity: Literal['dot', 'max'] = 'max'
    """ Type of operation for Gumbel Sinkhorn P matrix"""
    perm_mode: Literal['gold', 'normal'] = 'normal'
    """Mode of execution."""
    gold_path: str = ""
    """Path to gold P npy file directory."""
    gold_pname: str = ""
    """Name of gold P npy file."""
    gumbel_noise_factor: float = 1.0
    """Gumbel noise factor."""
    gumbel_temperature: float = 0.1
    """Gumbel temperature."""
    sinkhorn_iters: int = 10
    """Sinkhorn number of iterations."""
    use_indicator: bool = False
    """Switch for using atom indicator matrix."""
    perm_regularizer: Literal['zero_reg', 'squared_fro_norm', 'squared_fro_norm_inv', 'sqrt_squared_fro_norm_inv', 'batched_fro_norm', 'batched_fro_norm_inv', 'fro_norm_inv', 'abs_norm_inv'] = 'zero_reg'
    """Regularizer to be used with permutation."""
    perm_reg_lambda: float = 0.01
    """Lambda for regularizer loss."""
    loss_agg_func: Literal['sum', 'mean'] = 'sum'
    """Aggregator for model MSE loss."""
    ...
    aggregation: Literal['set2set', 'deepset', 'mean', 'sum', 'norm'] = 'mean'
    ...
    step_aggregation: Literal['set2set', 'deepset', 'capsule', 'sum'] = 'set2set'
    """Aggregation scheme for atomic vectors into molecular vectors"""
    
    use_node_tf:bool = False
    use_step_tf:bool = False
    step_tf: Literal['NNAttention', 'Transformer'] = 'NNAttention'
    
    reaction: bool = False
    """
    Whether to adjust MPNN layer to take reactions as input instead of molecules.
    """
    multistep: bool = False  ###changed
    """
    if 'reaction' then whether it's multistep reaction or not.
    """ 

...
class MoleculeModel(nn.Module):
    ...
    def create_ffn(self, args: TrainArgs) -> None:
        ...
        if self.is_atom_bond_targets:
            ...
            self.readout = build_ffn(
                ...
                hidden_size=args.ffn_hidden_size + args.atom_descriptors_size,  ####change
                num_layers=args.ffn_num_layers,
    ...
    def forward(
        ...
        """
        if self.is_atom_bond_targets:
            encodings, perm_loss = self.encoder(
                batch,
                features_batch,
                atom_descriptors_batch,
                atom_features_batch,
            ...
            encodings, perm_loss, dperms, hsim_trace, ssim_trace, p_gold, p_hard, p_phi = self.encoder(
                batch,
                features_batch,
                atom_descriptors_batch,
                atom_features_batch,
        ...
        return output, perm_loss, dperms, hsim_trace, ssim_trace, p_gold, p_hard, p_phi

...
def pred_g2(args):
    ...
    if args.ckpt_dir is None:
        model_path = test_file.split('dataset')[0]+'other_models/g2/'+data_dic[data_id][2]+'/h%d/min_val_model_one_hot_4EE_bs16_%d_%d_%d/' %(args.hidden_size, data_id, split_id, train_size)
    else:

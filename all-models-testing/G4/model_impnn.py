...
import warnings
import dgl
from dgl.nn.pytorch import NNConv, Set2Set, GINConv
...
class MPNN(nn.Module):
    ...
    def __init__(self, node_in_feats, edge_in_feats, hidden_feats = 20,
        ...
        self.lin = nn.Linear(hidden_feats, hidden_feats)
        '''
        ...
        self.gnn_layer = GINConv(self.lin, 'sum')
    ...
    def forward(self, g):
        ...
        for _ in range(self.num_step_message_passing):
            ...
            node_feats = self.activation(self.gnn_layer(g, node_feats)).unsqueeze(0)
...
class reactionMPNN(nn.Module):
    ...
    def __init__(self, node_in_feats, edge_in_feats, n_rmol, n_imol, args,
        ...
        self.mpnn = MPNN(node_in_feats, edge_in_feats, hidden_feats=args.hidden_size, readout_feats=args.hidden_size)
        self.data = args.data

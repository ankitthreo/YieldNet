...
class TrainArgs(CommonArgs):
    ...
    perm_type: Literal['soft'] = 'soft'
    """Type of permutation for the P matrix."""
    similarity: Literal['dot', 'max'] = 'dot'
    ...
    aggregation: Literal['set2set', 'mean', 'sum', 'norm'] = 'mean'
    ...
    step_aggregation: Literal['set2set', 'capsule', 'sum'] = 'set2set'
    """Aggregation scheme for atomic vectors into molecular vectors"""

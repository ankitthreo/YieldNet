...
if __name__ == "__main__":
    ...
    for data_id in [0]:
        ...
        for split_id in range(10):
            ...
            load_dict = np.load("./GPT/gp2/data_gp2_%d_total_split_%d.npz" %(data_id, split_id), allow_pickle = True)
            ...
            filename = '../../yield_prediction/data/chemprop/gp2/dataset_%d_%d.npz' %(data_id, split_id)
